...
1. [`tusk-bootstrap-contract.md`](./tusk-bootstrap-contract.md)
   Defines the bootstrap-first contract for entering a managed repo without
   taking ownership away from that repo.

2. [`tusk-workflow-topology.md`](./tusk-workflow-topology.md)
...
3. [`tusk-tracker-lease-service.md`](./tusk-tracker-lease-service.md)
...
4. [`tusk-architecture.md`](./tusk-architecture.md)
